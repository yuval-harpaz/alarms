...
LABELS = {
    'he': {
        ...
        'clear': 'נקה',
        'reset': 'איפוס',
        'reset_hint': 'ביטול כל הסינונים וחזרה לתצוגת ברירת המחדל',
        'help': 'מידע נוסף',
        ...
        'level_heat': 'מפת חום',
        'heat_smooth': 'רדיוס החלקה',
        'km': 'ק"מ',
        'heat_units': 'הרוגים לקמ"ר',
        'panel_hint': 'תצוגה ושכבות',
        'panel_display': 'תצוגה',
        'panel_colour': 'פילוח',
        'panel_base': 'מפת רקע',
    ...
    'en': {
        ...
        'clear': 'Clear',
        'reset': 'Reset',
        'reset_hint': 'Clear every filter and return to the default view',
        ...
        'level_heat': 'Heatmap',
        'heat_smooth': 'Smoothing radius',
        'km': 'km',
        'heat_units': 'deaths per km²',
        'panel_hint': 'Display and layers',
