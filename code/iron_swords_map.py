...
LABELS = {
    'he': {
        ...
        'front': 'זירה',
        'view_fronts': 'איחוד כל המקרים לפי זירה',
        'view_roles': 'איחוד לפי זירה, בצבעי תפקיד',
        'view_detail': 'תצוגה מפורטת',
    ...
    'en': {
        ...
        'front': 'Front',
        'view_fronts': 'All cases lumped by front',
        'view_roles': 'Lumped by front, coloured by role',
        'view_detail': 'The detailed map',
