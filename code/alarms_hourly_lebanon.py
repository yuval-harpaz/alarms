...
ax.bar(xu[:12]*2+(2 * np.pi /12 / 2), y[12:], width=2*np.pi/12, alpha=0.5, color='blue', label='PM')
ax.bar(xu[:12]*2+(2 * np.pi /12 / 2), y[:12], width=2*np.pi/12, alpha=0.5, color='red', label='AM')
ax.set_theta_direction(-1)
ax.set_theta_offset(np.pi/2)
