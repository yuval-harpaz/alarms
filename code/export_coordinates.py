...
sublocheb = {'אשקלון; בי"ח ברזילי',
             'בארי; ארוע בני ערובה',
             'יד מרדכי - נתיב העשרה; קבוצת ריצה',
             'כביש רעים – אורים (צפון)',
             'מטעים של בארי (מגורי עובדים)',
             'מיגונית בצומת גמה (דרום)',
             ...
             'סמוך למיגונית בצומת גמה (דרום)',
             'סמוך למיגונית בצומת גמה (צפון)',
             'עזה; ביה"ח שיפא',
             'עזה; מבנה סמוך לביה"ח שיפא',
             'עזה; מסגד סמוך לביה"ח שיפא',
             'פסטיבל נובה; אמבולנס',
             'פסטיבל נובה; במה מרכזית',
             'פסטיבל נובה; בר',
             'פסטיבל נובה; גשר נחל גרר',
             'פסטיבל נובה; חסימה בכביש 232': [31.399963, 34.474210],
             'פסטיבל נובה; מחסום בכביש 232',
             'פסטיבל נובה; מכולות צהובות',
             'שדרות; אוטובוס הגמלאים',
             'שדרות; תחנת משטרה'}
